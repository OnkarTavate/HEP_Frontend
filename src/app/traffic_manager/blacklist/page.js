...
export default function TrafficBlacklistPage() {
  ...
  // All other codes default to 0; the user can override manually.
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex flex-col gap-6 font-sans">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#0a1e4d] via-[#12275f] to-[#1b1856] p-6 text-white shadow-[0_12px_32px_-10px_rgba(10,30,77,0.65)] ring-1 ring-inset ring-white/15">
        ...
        <div className="pointer-events-none absolute left-1/3 -bottom-10 h-36 w-36 rounded-full bg-indigo-500/15 blur-2xl" />
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3.5">
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-rose-700 text-white shadow-lg shadow-red-500/30 ring-1 ring-white/30 shrink-0">
              <ShieldBan className="h-6 w-6" strokeWidth={2.4} />
            </span>
            <div>
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider text-red-200">
              ...
              <p className="text-[11px] text-blue-200/70 mt-0.5">Review ATM requests · Restrict entities · Reinstate access</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <button
              onClick={() => { fetchEntries(); fetchStats(); }}
              className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-bold ring-1 ring-inset ring-white/15 transition"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-400 hover:to-rose-500 text-white text-xs font-bold shadow-lg shadow-red-500/30 ring-1 ring-inset ring-white/20 active:scale-95 transition-all"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 shrink-0">
        ...
        >
          ...
          <div className="pointer-events-none absolute right-3 bottom-3 opacity-[0.08] group-hover:opacity-[0.14] transition-opacity duration-300">
          ...
          <div className="relative flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20 shadow-inner shrink-0">
                <Clock className="h-4 w-4 text-blue-200" strokeWidth={2.2} />
              </span>
              <span className="text-[11px] font-bold uppercase tracking-widest text-blue-200/80 leading-tight">Pending ATM</span>
            </div>
            {(stats?.pending_blacklist || 0) > 0 && (
              <span className="flex items-center gap-1 text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-white text-indigo-700 shadow-md animate-pulse">
                <span className="h-1.5 w-1.5 rounded-full bg-indigo-500 inline-block" /> Live
              </span>
            )}
          </div>
          <div className="relative mt-3">
            <p className="text-4xl font-black text-white tabular-nums tracking-tight leading-none drop-shadow-md">
              {stats?.pending_blacklist || 0}
            </p>
            <p className="text-[11px] font-semibold text-blue-200/70 mt-1.5 leading-snug">Awaiting review</p>
          </div>
          <div className="relative mt-4">
            <div className="h-1 w-full rounded-full bg-white/10 overflow-hidden">
              <div className="h-full rounded-full bg-gradient-to-r from-blue-300 via-indigo-300 to-violet-300 transition-all duration-700" style={{ width: (stats?.pending_blacklist || 0) > 0 ? "100%" : "0%" }} />
            </div>
          </div>
        </div>

        {/* Card 2: Active Blacklisted */}
        <div
          onClick={() => { setActiveTab("active"); setSearchInput(""); setEntityFilter(""); }}
          role="button"
          tabIndex={0}
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#7f1d1d] via-[#b91c1c] to-[#991b1b] p-6 text-white shadow-xl shadow-red-900/40 ring-1 ring-inset ring-white/15 cursor-pointer min-h-[148px] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-red-600/50 focus:outline-none"
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 to-transparent" />
          <div className="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-red-400/20 blur-2xl" />
          <div className="pointer-events-none absolute right-3 bottom-3 opacity-[0.08] group-hover:opacity-[0.14] transition-opacity duration-300">
            <ShieldBan className="h-20 w-20 text-white" strokeWidth={1.2} />
          </div>
          <div className="relative flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20 shadow-inner shrink-0">
                <ShieldBan className="h-4 w-4 text-red-200" strokeWidth={2.2} />
              </span>
              <span className="text-[11px] font-bold uppercase tracking-widest text-red-200/80 leading-tight">Active Blocks</span>
            </div>
          </div>
          <div className="relative mt-3">
            <p className="text-4xl font-black text-white tabular-nums tracking-tight leading-none drop-shadow-md">
              {stats?.active_blacklisted || 0}
            </p>
            <p className="text-[11px] font-semibold text-red-200/70 mt-1.5 leading-snug">Entities blocked now</p>
          </div>
          <div className="relative mt-4">
            <div className="h-1 w-full rounded-full bg-white/10 overflow-hidden">
              <div className="h-full rounded-full bg-gradient-to-r from-red-300 via-rose-300 to-pink-300 transition-all duration-700" style={{ width: (stats?.active_blacklisted || 0) > 0 ? "100%" : "0%" }} />
            </div>
          </div>
        </div>

        {/* Card 3: Pending Unblacklist */}
        <div
          onClick={() => { setActiveTab("active"); setSearchInput(""); setEntityFilter(""); }}
          role="button"
          tabIndex={0}
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#78350f] via-[#d97706] to-[#b45309] p-6 text-white shadow-xl shadow-amber-900/40 ring-1 ring-inset ring-white/15 cursor-pointer min-h-[148px] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-amber-600/50 focus:outline-none"
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 to-transparent" />
          <div className="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-amber-400/20 blur-2xl" />
          <div className="pointer-events-none absolute right-3 bottom-3 opacity-[0.08] group-hover:opacity-[0.14] transition-opacity duration-300">
            <AlertTriangle className="h-20 w-20 text-white" strokeWidth={1.2} />
          </div>
          <div className="relative flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20 shadow-inner shrink-0">
                <AlertTriangle className="h-4 w-4 text-amber-200" strokeWidth={2.2} />
              </span>
              <span className="text-[11px] font-bold uppercase tracking-widest text-amber-200/80 leading-tight">Unblock Requests</span>
            </div>
          </div>
          <div className="relative mt-3">
            <p className="text-4xl font-black text-white tabular-nums tracking-tight leading-none drop-shadow-md">
              {stats?.pending_unblacklist || 0}
            </p>
            <p className="text-[11px] font-semibold text-amber-200/70 mt-1.5 leading-snug">Awaiting reinstatement</p>
          </div>
          <div className="relative mt-4">
            <div className="h-1 w-full rounded-full bg-white/10 overflow-hidden">
              <div className="h-full rounded-full bg-gradient-to-r from-amber-300 via-yellow-300 to-orange-300 transition-all duration-700" style={{ width: (stats?.pending_unblacklist || 0) > 0 ? "100%" : "0%" }} />
            </div>
          </div>
        </div>

        {/* Card 4: Total Cleared */}
        <div
          onClick={() => { setActiveTab("history"); setSearchInput(""); setEntityFilter(""); }}
          role="button"
          tabIndex={0}
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#064e3b] via-[#0f766e] to-[#0e7490] p-6 text-white shadow-xl shadow-emerald-900/40 ring-1 ring-inset ring-white/15 cursor-pointer min-h-[148px] flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-600/50 focus:outline-none"
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/60 to-transparent" />
          ...
          <div className="relative flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-bold uppercase tracking-widest text-emerald-200/80 leading-tight">Reinstated</span>
            </div>
            <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-emerald-400/20 text-emerald-200 border border-emerald-400/30">History</span>
          </div>
          <div className="relative mt-3">
            <p className="text-4xl font-black text-white tabular-nums tracking-tight leading-none drop-shadow-md">
              {stats?.total_unblacklisted || 0}
            </p>
            <p className="text-[11px] font-semibold text-emerald-200/70 mt-1.5 leading-snug">Entities cleared</p>
          </div>
          <div className="relative mt-4">
            <div className="h-1 w-full rounded-full bg-white/10 overflow-hidden">
              <div className="h-full rounded-full bg-gradient-to-r from-emerald-300 via-teal-300 to-cyan-300 transition-all duration-700" style={{ width: (stats?.total_unblacklisted || 0) > 0 ? "100%" : "0%" }} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/60 backdrop-blur-md p-4 animate-in fade-in duration-200">
          <div className="bg-white/95 backdrop-blur-xl w-full max-w-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden animate-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
            <div className="flex justify-between items-center px-4 sm:px-6 py-4 sm:py-4.5 bg-gradient-to-r from-slate-950 via-red-950 to-slate-950 text-white shrink-0 border-b border-red-500/20 shadow-md">
              ...
              <button
                onClick={() => { setIsCreateOpen(false); setSupportingFile(null); setGeotagStatus("No location tagged"); setGeotagEnabled(false); }}
            ...
            <form onSubmit={handleCreate} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
              ...
              {/* Geotagging GPS Widget — Optional (tick to enable) */}
              <div className="space-y-2">
                ...
                <label className="flex items-start gap-3 cursor-pointer bg-slate-50 border border-slate-200 rounded-xl p-3 hover:border-blue-300 hover:bg-blue-50/30 transition-all">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5">Tick to attach GPS coordinates using your device.</p>
                  </div>
                </label>

                {/* Show GPS controls only when enabled */}
                {geotagEnabled && (
                    ...
                    {(() => {
                      ...
                      return total > 0 ? (
                        <div className="rounded-xl border border-orange-200 bg-orange-50/50 overflow-hidden animate-in fade-in duration-200">
                          <div className="px-3 py-2 bg-orange-100/60 border-b border-orange-200 flex items-center gap-1.5">
