...
function UserProfilePanel({ user, departmentName, onChangePassword, onLogout }) {
  ...
  const username = user?.username || "Marine Admin";
  const displayName = username.split("@")[0] || "Marine Admin";
    ...
    >
      <div className="w-full h-full bg-slate-50 dark:bg-[#11131e] flex overflow-hidden transition-colors duration-300">
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
          <header className="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-3 shrink-0 bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border-b border-slate-200/50 dark:border-white/5 transition-colors duration-300 relative z-40">
            ...
            <div className="flex items-center gap-3">
              ...
              <UserProfilePanel
                user={user}
                departmentName="Marine Department"
